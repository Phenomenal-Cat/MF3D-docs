...
(```MF3D_StimEditor.m`` <>`__) to help users of the MF3D R1 stimulus set
...
`MF3D_Download.m <>`_ GUI as follows:
...
-  Open Matlab, navigate to the 'MF3D Tools' folder and run ``MF3D_Download`` in the Matlab command line. Note that the script requires permissions to move the code and image files around.
...
.. image:: _images/MF3D_Tools_Installer.png
  :width: 500
